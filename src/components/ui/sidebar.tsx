...
>(
  (
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-sidebar p-0 rounded-tr-lg rounded-br-lg text-sidebar-foreground border-0 [&>button]:hidden"
            style={
              {
    ...
    const isCollapsed = state === "collapsed" && isIconCollapsible;
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* Desktop gap / spacer that reserves width for the sidebar */}
        <div
          className={cn(
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-sidebar rounded-tr-lg rounded-br-lg group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow"
          >
            {children}
          </div>
        </div>
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-all duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
>(({ className, showIcon = false, ...props }, ref) => {
  // Deterministic width between 50% to 90% (keeps render pure).
